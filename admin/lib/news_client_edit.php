...
if ($action==="save"){
        ...
        $query="insert into t_promotion_client (`title`,`desc`,`category`,`image`,`content`,`create_user`,`create_time`)values 
...
if($action==="edit"){
    ...
    $query = "update t_promotion_client set `title`='$title',`desc`='$desc',`category`='$category',
