...
if ($name!=""){
    $sqlKey .= " and e.`name` like '%$name%'";
}



$Query = "Select count(*) as c from t_role where 1=1 $sqlKey";
...
$sql = "select * from t_role
            where 1=1 $sqlKey order by id desc limit $offset,$Page_size";
...
$content.="    </div></td>\n";
$content.="    <td height='18' >".$row['id']."</td>\n";
$content.="    <td height='18' >".$row['name']."</td>\n";
$content.="    <td height='18'><img src='../images/edit.gif'>[<a href=\"role_edit.php?id=".$row['id']."&action=edit\">编辑</a>]</td>";
$content.="</tr>\n";
}
  ...
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="../images/tab_05.gif" class="tdStyle tdNavMn"><img src="../images/001.gif" width="14" height="14" /><a href="role_edit.php" >添加</a></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <label style="width:120px"><span ></span> 角色名称：</label><input type="text" id="name" name="name" style="width:200px" value="<?php echo $name?>">  
