...
if ($action=="edit"){
 $id=$_GET["id"];    
    if(is_numeric($id)){
        ...
        $Query = "select * from t_employee where is_del=0 and id=$id";
  ...
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="../images/tab_05.gif" class="tdStyle tdNavMn"><img src="../images/seek.gif" width="16" height="16" /><a href="javascript:void(0)" onClick="window.location='employee_list.php'">查询</a> <img src="../images/001.gif" width="14" height="14" /><a href="javascript:void(0)" onClick="resetForm();">添加记录</a></td>
...
<label style="width:120px"><span>*</span> 姓名：</label><input type="text" id="trueName" name="trueName" style="width:200px" value="<?php echo $trueName?>"></br>
<label style="width:120px"><span>*</span> 性别：</label>
<select id="sex" name="sex">
<option value="">请选择<?php echo $sex?></option>
<option value="男" <?php if($sex=="男") echo "selected";?>>男</option>
<option value="女" <?php if($sex=="女") echo "selected";?>>女</option>
</select>
</br>
<label style="width:120px"><span></span> 身份证号：</label><input type="text" id="userId" name="userId"   style="width:200px" value="<?php echo $userId?>"></br>
