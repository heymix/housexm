...
if ($name!=""){
    $sqlKey .= " and `name` like '%$name%'";
}
if($simpleName!=""){
    $sqlKey .= " and `simple_name` like '%$simpleName%'";
}
if($contact!=""){
    $sqlKey .= " and `contact` like '%$contact%'";
}
if($tel!=""){
    $sqlKey .= " and `tel` like '%$tel%'";
}
if($remark!=""){
    $sqlKey .= " and `remark` like '%$remark%'";
}



$Query = "Select count(*) as c from t_company where is_del=0 $sqlKey";
...
$sql = "select * from t_company where is_del=0 $sqlKey order by id desc limit $offset,$Page_size";
...
$editStr="";
if(checkPower("11")){
    $editStr="<img src='../images/edit.gif'>[<a href=\"company_edit.php?id=".$row['id']."&action=edit\">编辑</a>]";
}
  ...
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="550" background="../images/tab_05.gif" class="tdStyle"><img src="../images/operatePanle.gif" width="16" height="16" /> <span class="tbTitle">操作面板>>公司管理</span></td>
        <td background="../images/tab_05.gif" class="tdStyle tdNavMn"><?php if(checkPower("11")){?> <img src="../images/001.gif" width="14" height="14" /><a href="company_edit.php" >添加公司</a><?php }?></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <label style="width:120px"><span id="name"></span> 名称：</label><input type="text" id="name" name="name" style="width:200px" value="<?php echo $name?>"> <img src="../images/g_page.gif" width="14" height="14" /> 
        	<label style="width:120px"><span id="name"></span> 简称：</label><input type="text" id="simpleName" name="simpleName" style="width:200px" value="<?php echo $simpleName?>"> <img src="../images/g_page.gif" width="14" height="14" /> 
        	<label style="width:120px"><span id="name"></span> 联系人：</label><input type="text" id="contact" name="contact" style="width:200px" value="<?php echo $contact?>"> <img src="../images/g_page.gif" width="14" height="14" /> <br>
        	<label style="width:120px"><span id="name"></span> 电话：</label><input type="text" id="tel" name="tel" style="width:200px" value="<?php echo $tel?>"> <img src="../images/g_page.gif" width="14" height="14" /> 
        	<label style="width:120px"><span id="name"></span> 备注：</label><input type="text" id="remark" name="remark" style="width:200px" value="<?php echo $remark?>"> <img src="../images/g_page.gif" width="14" height="14" /> 
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tbody><tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tbody><tr>
        <td width="15" height="30"><img src="../images/tab_03.gif" width="15" height="30"></td>
        <td width="275" background="../images/tab_05.gif" class="tdStyle"><img src="../images/311.gif" width="16" height="16"> <span class="tbTitle">渠道公司列表</span></td>
        <td background="../images/tab_05.gif" class="tdStyle tdNavMn"><a href="javascript:void(0)" onclick="window.location.reload();"><img src="../images/refresh.gif" width="16" height="16"></a>
           <?php if(checkPower("11")){?><input id="checkAll" type="checkbox" name="checkbox62" value="checkbox" onblur="selectAll(this);">
          全选
        ...
        <td bgcolor="#f3ffe3"><form id="listForm" name="listForm" method="post">
          ...
          <table class="list_table" width="99%" border="0" align="center" cellpadding="0" cellspacing="1">
            <tbody><tr class="alt">
              ...
              <th width="12%" height="26">电话</th>
              <th width="12%" height="26">备注</th>
