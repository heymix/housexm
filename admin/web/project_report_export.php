...
where t.is_del=0 $sqlKey group by t.project_id";
...
while($row = mysql_fetch_array($rs)) {
    $i=$i+1;
    $objPHPExcel->setActiveSheetIndex(0)
    ->setCellValue("A$i", $row['project_name'])
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('项目统计');
...
header("Content-Disposition: attachment;filename='project_report".time().".xls'");
