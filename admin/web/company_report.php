...
where t.is_del=0 $sqlKey group by e.company_id) as t";
...
$sql = "SELECT sum(price) as price_sum,c.name as company_name
...
where t.is_del=0 $sqlKey group by e.company_id limit $offset,$Page_size";
//echo $sql;
...
$content.="    </div></td>\n";
$content.="    <td height='18' ><span class='tdStyle'>".$row['company_name']."</span></td>\n";
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tbody><tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tbody><tr>
        <td width="15" height="30"><img src="../images/tab_03.gif" width="15" height="30"></td>
        <td width="275" background="../images/tab_05.gif" class="tdStyle"><img src="../images/311.gif" width="16" height="16"> <span class="tbTitle">渠道公司报表</span></td>
