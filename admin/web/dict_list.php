...
$Query = 'Select count(*) as c from t_dictionary';
...
$sql = "select * from t_dictionary order by type asc,order_id desc limit $offset,$Page_size";
...
$content.="    </div></td>\n";
$content.="    <td height='18' ><span class='tdStyle'>".$row['type']."</span></td>\n";
$content.="    <td height='18' >".$row['name']."</td>\n";
$content.="    <td height='18' >".$row['value']."</td>\n";
$content.="    <td height='18' >".$row['order_id']."</td>\n";
$content.="    <td height='18'><img src='../images/edit.gif'>[<a href=\"dict.php?id=".$row['id']."&action=edit\">编辑</a>]</td>";
$content.="</tr>\n";
}
  ...
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="550" background="../images/tab_05.gif" class="tdStyle"><img src="../images/operatePanle.gif" width="16" height="16" /> <span class="tbTitle">操作面板>>数据字典</span></td>
        <td background="../images/tab_05.gif" class="tdStyle tdNavMn"><img src="../images/seek.gif" width="16" height="16" /><a href="javascript:void(0)" onClick="opType('0','','')">查询</a> <img src="../images/001.gif" width="14" height="14" /><a href="dict.php" >添加字典</a></td>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tbody><tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tbody><tr>
        <td width="15" height="30"><img src="../images/tab_03.gif" width="15" height="30"></td>
        <td width="275" background="../images/tab_05.gif" class="tdStyle"><img src="../images/311.gif" width="16" height="16"> <span class="tbTitle">字典列表</span></td>
        ...
        <td bgcolor="#f3ffe3"><form id="listForm" name="listForm" method="post">
          <table class="list_table" width="99%" border="0" align="center" cellpadding="0" cellspacing="1">
            <tbody><tr class="alt">
              ...
              <th width="12%" height="26">值</th>
              <th width="12%" height="26">排序</th>
