...
where t.is_del=0 $sqlKey group by t.employee_id) as t";
//echo $Query;
...
$sql = "SELECT sum(price) as price_sum,e.user_name,e.true_name,e.tel as employee_tel,c.name as company_name
...
where t.is_del=0 $sqlKey group by t.employee_id limit $offset,$Page_size";
//echo $sql;
...
function exportExcel(){
	...
	window.location.href="employee_report_export.php?1=1&"+$("#searchForm").serialize();
}
</script>
  ...
  <tbody><tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tbody><tr>
        ...
        <td background="../images/tab_05.gif" class="tdStyle tdNavMn"> <img src="../images/excel.gif" width="14" height="14"><font><a href="javascript:void(0)" onclick="exportExcel();">导出excel</a></font></td>
        <td width="14"><img src="../images/tab_07.gif" width="14" height="30"></td>
      </tr>
    </tbody></table></td>
  </tr>
