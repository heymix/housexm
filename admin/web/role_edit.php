  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td bgcolor="#f3ffe3"  class="tdStyle"><form method="post" id="editForm" name="editForm"  title="角色管理" >
...
<label style="width:120px"><span>*</span> 用户名：</label><input <?php if($action=="edit") echo "disabled"; ?> type="text" id="name" name="name" style="width:200px" value="<?php echo $name;?>"></br><br/>
